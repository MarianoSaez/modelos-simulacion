...
# CONSTANTS
END_OF_QUEUEING = 4 * 60 * 60 # 4hs of service
COST_OF_BOX = 1000
COST_OF_LOSS = 10000


if __name__ == "__main__":
    for n_box in range(1, 11):  
        NO_OF_BOXES = n_box
        ...
        out = cv2.VideoWriter(f'simulation_{n_box}_boxes.avi', fourcc, 60, (1280, 720))
